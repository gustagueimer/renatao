...
#include <windows.h>
//balls 101
int notas(char nomeAluno[20][10], char notaConceitualAluno[20][10], int matriculaAluno[10], int notaNominalFinal[10]) {
    for (int i = 1; i < 4; i++) {
...
int main() {
    ...
    notas(nomeAluno, notaConceitualAluno, matriculaAluno, notaNominalFinal);
    return 0;
}